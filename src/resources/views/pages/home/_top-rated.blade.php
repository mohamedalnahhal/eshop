<section>
  <div class="flex items-center justify-between mb-6">
      <div class="flex items-center gap-3">
          <h2 class="text-theme-2xl font-bold text-theme">{{ $section['title'] }}</h2>
          @if(!empty($section['badge_label']))
              <span class="badge bg-gold-surface text-on-gold border border-gold">{{ $section['badge_label'] }}</span>
          @endif
      </div>
